...
request.setCharacterEncoding("UTF-8");
	...
	if(keyword!=null)
	{
		...
		else
		{
			...
			//strPath = app.getRealPath("/"); //获得根目录的绝对路径 no
			
			strPath ="C:\\Users\\GCY\\Downloads\\Simple_Search_Engine-master\\Simple_Search_Engine-master\\SearchEngine\\SearchEngine\\WebRoot\\";
...
<html>
  <head>
    ...
    <link href="Images/g14.ico" rel="bookmark" />
    <link href="Images/g14.ico" rel="shortcut icon" />
 <script language="javascript" type="text/javascript">  
  ...
  <body>
    ...
    <div id="head">
           <a herf="index.jsp" id="input_a"><img alt="萌娘百科搜索"  class="inputimg"></a>
